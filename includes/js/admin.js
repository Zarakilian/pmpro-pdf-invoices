...
jQuery(document).ready(function ($) {
    ...
    jQuery('.pmpro-pdf-generate').click(function (e) {
        ...
        var data = {
            ...
            order_code: $button.attr('order_code'),
        ...
        // Do loading on click.
        $button.html('<img src="' + data.loading_gif + '" alt="loading gif" width="20px"/>');
        ...
        jQuery.ajax({
            ...
            data: data,
            error: function () {
                $button.html('Error generating PDF. Please try again.');
            },
            success: function (responseHTML) {
                if (responseHTML == 'error') {
                    $button.html('Error generating PDF. Please refresh and try again.');
                } else {
